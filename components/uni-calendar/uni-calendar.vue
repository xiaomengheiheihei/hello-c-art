<template>
	<view>
		<view class="c-calendar__box">
			<view class="c-calendar__wrapper">
				<view class="c-calenda__content">
					<view class="c-calendar__panel">
						<view class="c-calendar__date-befor" @tap="dataBefor('0', 'month')">
							<text class="iconfont icon-jiantou" />
						</view>
						<view class="c-calendar__panel-box">
							<view>{{ canlender.year }}年</view>
							<view>{{ canlender.month }}月</view>
						</view>
						<view class="c-calendar__date-after c-calendar__rollback" @tap="dataBefor('1', 'month')">
							<text class="iconfont icon-jiantou " />
						</view>
						<view class="c-calendar__backtoday" @tap="backtoday">回到今天</view>
					</view>
					<view v-if="lunar" class="c-calendar__day-detail">
						<view>
							{{
                canlender.year +
                  '年' +
                ...
                canlender.lunar.gzYear +
                  ...
                  '年)'
					...
					<view class="c-calendar__header">
						<view class="c-calendar__week">日</view>
						<view class="c-calendar__week">一</view>
						<view class="c-calendar__week">二</view>
						<view class="c-calendar__week">三</view>
						<view class="c-calendar__week">四</view>
						<view class="c-calendar__week">五</view>
						<view class="c-calendar__week">六</view>
					</view>
					<c-calendar-item v-if="slide === 'none'" :canlender="canlender" :lunar="lunar" @selectDays="selectDays" />
					<swiper v-else :style="{ height: domHeihgt + 'px' }" :current="currentIndex" :vertical="slide === 'vertical' ? true : false" :duration="duration" class="c-calendar__body" circular skip-hidden-item-layout @animationfinish="animationfinish" @change="change">
						<swiper-item v-for="(item, itemindx) in swiperData" :key="itemindx">
							<view :class="elClass">
								<c-calendar-item :canlender="item" :lunar="lunar" @selectDays="selectDays" />
							</view>
						</swiper-item>
					</swiper>
				</view>
...
<script>
	...
	import uniCalendarItem from './c-calendar-item'
	export default {
		name: 'UniCalendar',
		components: {
			uniCalendarItem
		...
		methods: {
			...
			getQueryDom(index) {
				let dom = c.createSelectorQuery().in(this).selectAll(`.${this.elClass}`)
...
<style>
	...
	.c-calendar__wrapper .c-calenda__content .c-calendar__panel {
		position: relative;
		display: flex;
		align-items: center;
		justify-content: center;
	...
	.c-calendar__wrapper .c-calenda__content .c-calendar__panel .c-calendar__date-after,
	.c-calendar__wrapper .c-calenda__content .c-calendar__panel .c-calendar__date-befor {
		display: flex;
		justify-content: center;
		align-items: center;
		height: 80rpx;
	...
	.c-calendar__wrapper .c-calenda__content .c-calendar__panel .c-calendar__date-after.c-calendar__rollback,
	.c-calendar__wrapper .c-calenda__content .c-calendar__panel .c-calendar__date-befor.c-calendar__rollback {
		transform: rotate(180deg)
	}

	.c-calendar__wrapper .c-calenda__content .c-calendar__panel .c-calendar__panel-box {
		display: flex;
		justify-content: center;
		align-items: center;
		width: 200upx
	...
	.c-calendar__wrapper .c-calenda__content .c-calendar__panel .c-calendar__backtoday {
		position: absolute;
		right: 0;
		top: 15rpx;
		padding: 0 10rpx;
	...
	.c-calendar__wrapper .c-calenda__content .c-calendar__day-detail {
		padding: 20upx;
		padding-left: 30upx;
		border-top: 1px #f5f5f5 solid
	}

	.c-calendar__wrapper .c-calenda__content .c-calendar__header {
		display: flex;
		font-size: 28upx;
		border-top: 1px #f5f5f5 solid
	}

	.c-calendar__wrapper .c-calenda__content .c-calendar__header .c-calendar__week {
		width: 100%;
		text-align: center;
		line-height: 80rpx;
		color: #333;
	...
	.c-calendar__wrapper .c-calenda__content .c-calendar__body {
		display: flex;
		flex-wrap: wrap;
		font-size: 28upx
	}
