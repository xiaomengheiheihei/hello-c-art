<template>
	<view>
		...
		<view class="c-padding-wrap">
			<view class="c-title">分享内容</view>
			<view class="c-textarea">
				<textarea class="textarea" v-model="shareText" />
				</view>
			<view class="c-title">分享图片：</view>
			<view class="c-uploader" style="padding:15upx; background:#FFF;">
				<view class="c-uploader__input-box" v-if="!image" @tap="chooseImage"></view>
				<image class="c-uploader__img" v-if="image" :src="image"></image>
			</view>
			<!-- #ifdef APP-PLUS -->
			<view class="c-title">分享类型：</view>
			<view>
			...
			<view class="c-btn-v c-common-mt" v-if="providerList.length > 0">
...
<script>
	export default {
		data() {
			return {
				title: 'share',
				shareText: 'c-app可以同时发布成原生App、小程序、H5，邀请你一起体验！',
		...
		onShareAppMessage() {
			return {
				title: this.shareText ? this.shareText : "欢迎体验c-app",
				path: '/pages/tabBar/component/component',
				imageUrl:this.image ? this.image : 'https://img-cdn-qiniu.dcloud.net.cn/uniapp/app/share-logo@3.png'
			}
		},
		onUnload:function(){
			this.shareText='c-app可以同时发布成原生App、小程序、H5，邀请你一起体验！',
