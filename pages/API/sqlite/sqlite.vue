<template>
	<view>
		...
		<view class="c-padding-wrap c-common-mt">
			<view class="c-btn-v"><button type="primary" @click="openDB">打开数据库test.db</button></view>
			<view class="c-btn-v"><button type="primary" @click="executeSQL">创建表database及插入数据</button></view>
			<view class="c-btn-v"><button type="primary" @click="selectSQL">查询表database的数据</button></view>
			<view class="c-btn-v"><button type="primary" @click="droptable">删除表database</button></view>
			<view class="c-btn-v"><button type="primary" @click="closeDB">关闭数据库test.db</button></view>
			<view class="c-btn-v"><button type="primary" @click="isOpenDB">查询是否打开数据库</button></view>
