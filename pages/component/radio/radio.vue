<template>
	<view>
		...
		<view class="c-padding-wrap">
			<view class="c-title">不同颜色和尺寸的radio</view>
			<view>
				<label class="radio" style="margin-right: 30upx;">
		...
		<view class="c-title c-common-mt c-common-pl">推荐展示样式</view>
		<view class="c-list">
			<radio-group @change="radioChange">
				<label class="c-list-cell c-list-cell-pd" v-for="(item, index) in items" :key="item.value">
					<view>
