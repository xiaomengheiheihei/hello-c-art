	...
	<view>
		...
		<view class="c-padding-wrap c-common-mt">
			<view class="c-hello-text">
				Flex是Flexible Box的缩写，意为“弹性布局”，用来为盒状模型提供最大的灵活性。当设置display: flex后，继续给view等容器组件设置flex-direction: row或column，就可以在该容器内按行或列排布子组件。c-app默认全局使用flex布局(在App.vue里预设了)。因为flex布局有利于跨更多平台，尤其是采用原生渲染的平台。
			</view>
			
			<view class="c-title c-common-mt">
				flex-direction: row
				<text>\n横向布局</text>
			</view>
			<view class="c-flex c-row">
				<view class="flex-item c-bg-red">A</view>
				<view class="flex-item c-bg-green">B</view>
				<view class="flex-item c-bg-blue">C</view>
			</view>
			...
			<view class="c-flex c-column">
				<view class="flex-item flex-item-V c-bg-red">A</view>
				<view class="flex-item flex-item-V c-bg-green">B</view>
				<view class="flex-item flex-item-V c-bg-blue">C</view>
			</view>
			...
			<view>
				...
				<view class="c-flex c-row" style="justify-content: center;">
					<view class="text">横向布局-居中</view>
					<view class="text">横向布局-居中</view>
				</view>
				<view class="c-flex c-row" style="justify-content: flex-end;">
				...
				<view class="c-flex c-row" style="justify-content: space-between;">
				...
				<view class="c-flex c-row" style="flex-wrap: wrap;">
			...
			<view class="c-flex c-row">
				...
				<view class="c-flex c-column" style="flex: 1;justify-content: space-between;">
