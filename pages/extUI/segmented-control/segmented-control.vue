<template>
	<view>
		<view class="c-padding-wrap c-common-mt">
			<c-segmented-control :current="current" :values="items" :style-type="styleType" :active-color="activeColor" @clickItem="onClickItem" />
		</view>
		<view class="content">
		...
		<radio-group class="c-list" @change="styleChange">
			<label v-for="(item, index) in styles" :key="index" class="c-list-item">
		...
		<radio-group class="c-list" @change="colorChange">
			<label v-for="(item, index) in colors" :key="index" class="c-list-item">
				<view class="c-list-item__container">
					<view class="c-list-item__content">
...
<script>
	import uniSegmentedControl from '@/components/c-segmented-control/c-segmented-control.vue'
