	...
	<view>
		...
		<template v-else>
			<view class="c-padding-wrap c-common-pb">
				<view class="c-header-logo"><image src="/static/apiIndex.png"></image></view>
				<view class="c-hello-text c-common-pb">
					以下将演示c-app接口能力，详细文档见：
				...
				<view class="c-card" v-for="(list, index) in lists" :key="index">
					<view class="c-list">
						<view class="c-list-cell c-collapse">
							<view
								class="c-list-cell-navigate c-navigate-bottom"
								hover-class="c-list-cell-hover"
								:class="list.open ? 'c-active' : ''"
							...
							<view class="c-list c-collapse" :class="list.open ? 'c-active' : ''">
								...
								>
									<view class="c-list-cell-navigate c-navigate-right">{{ item.name }}</view>
								</view>
							</view>
						</view>
					</view>
