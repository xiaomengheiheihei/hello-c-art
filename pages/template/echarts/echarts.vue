<template>
	<view class="container">
		<view class="page-section-title" style="display: block;">
			<view class="c-hello-text c-common-pb" style="display: block;">
...
<style>
	...
	view {
		display: flex;
		/* c-app默认使用flex布局。因为flex布局有利于跨更多平台，尤其是采用原生渲染的平台。如不了解flex布局，请参考http://www.w3.org/TR/css3-flexbox/。若不需要flex布局可删除本行*/
	}
