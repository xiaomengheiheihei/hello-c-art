        ...
        <view class="feedback-body feedback-uploader">
            <view class="c-uploader">
                <view class="c-uploader-head">
                    <view class="c-uploader-title">点击预览图片</view>
                    <view class="c-uploader-info">{{imageList.length}}/8</view>
                </view>
                <view class="c-uploader-body">
                    <view class="c-uploader__files">
                        <block v-for="(image,index) in imageList" :key="index">
                            <view class="c-uploader__file" style="position: relative;">
                                <image class="c-uploader__img" :src="image" @tap="previewImage(index)"></image>
                                <view class="close-view" @click="close(index)">x</view>
                            </view>
                        </block>
                        <view class="c-uploader__input-box" v-show="imageList.length < 8">
                        	<view class="c-uploader__input" @tap="chooseImg"></view>
                        </view>
                    </view>
                </view>
            </view>
